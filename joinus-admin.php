...
<!--Sign up box-->
<section class="login">
    <form class="login-form" action="include/signup-admin.inc.php" id="form" method="post" onsubmit="validate()">
        ...
        <div class="inputs"><label>Have an account?<a href="login-admin.html">Log In</a></label></div>
    </form>
    <?php
    if(isset($_GET["error"])){
